...
# AKIA3FLDYJA6HOXBXHFF
# arn:aws:s3:::terraform-backend-state-kartikeyaag
# subnet-0521bf558d126cc74
...
module "in28minutes-cluster" {
  ...
  subnet_ids         = ["subnet-0521bf558d126cc74", "subnet-0da54959f8636814e", "subnet-09d305970b9d7a45a"] #CHANGE # Donot choose subnet from us-east-1e
